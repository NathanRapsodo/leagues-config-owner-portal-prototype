...
const SEED_DATA: DB = {
  ...
  seasons: [
    // City Links — Spring 2025 (completed: all events in the past)
    {
      ...
      leagueLink: "https://demo.offscript.local/join/10000001-0000-0000-0000-000000000001",
    ...
    // City Links — Summer 2026 (live: events span the current date Feb 27 2026)
    {
      ...
      leagueLink: "https://demo.offscript.local/join/10000002-0000-0000-0000-000000000002",
    ...
    // Weekend Warriors — 2026 Spring Series (upcoming: events start Apr 2026)
    {
      ...
      status: "published",
      payment: { mode: "free" },
      leagueLink: "https://demo.offscript.local/join/10000003-0000-0000-0000-000000000003",
